...
namespace personal_library_management_system
{
    public partial class HomePage : Page
    {
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["LibraryContext"].ConnectionString;
            string query = @"SELECT bb.BorrowID, b.Title, bb.BorrowDate, bb.DaysBorrowed
                             FROM BorrowedBooks bb
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["LibraryContext"].ConnectionString;
            string query = "INSERT INTO BorrowedBooks (BookID, FriendID, DaysBorrowed) VALUES (@BookID, @FriendID, @DaysBorrowed)";
        ...
        {
            string connectionString = ConfigurationManager.ConnectionStrings["LibraryContext"].ConnectionString;
            string query = "UPDATE BorrowedBooks SET ReturnDate = 1 WHERE BorrowID = @BorrowID";
